...
device_methods network_gamepad::methods;

const event_decl nd_events[] = {
...
const option_decl network_device_options[] = {
  {nullptr, nullptr, nullptr},
};

network_gamepad::network_gamepad() {
  pipe(statepipe);
}
...
void network_gamepad::process(void* tag) {
